  ...
  return (
    <header className="sticky top-0 z-40 w-full text-white transition-colors">
      <div className="container mx-auto py-2">
        <div className={`${scrolled ? "bg-[#0B0F1A]/40 border-white/5 backdrop-blur" : "bg-[#0B0F1A]/20 border-white/5"} flex h-14 items-center justify-between rounded-full px-4 md:px-6`}>
